...
| Pi judge transport and controls | `v0.84.2`, commit `914cf1472e715297caa30db4b9535d534a9eb718` | Temporary loopback and host probes covered transport, thinking, preferences, commands, status, and reset. |
| Node.js test suite | `24.9.0` | 246 unit, runtime, integration, privacy, race, and conformance tests passed for 0.4.2; runtime source is unchanged from 0.4.0. |

Version 0.4.2 retains the Pi 0.84.2 requirement for persistent controls and explicit secondary-model thinking introduced in 0.4.0. The Pi 0.84.2 probes used a temporary package, profile, and loopback OpenAI-compatible server. They did not use credentials, contact a real model, or modify the active Pi 0.84.1 installation.
...
- [Use Pi judge controls](../../guide/pi-controls/).
