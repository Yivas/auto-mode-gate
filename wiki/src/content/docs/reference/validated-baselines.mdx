...
| Node.js test suite | `24.9.0` | 246 unit, runtime, integration, privacy, race, and conformance tests passed for 0.4.0. |

Version 0.4.0 requires Pi 0.84.2 for persistent controls and explicit secondary-model thinking. The Pi 0.84.2 probes used a temporary package, profile, and loopback OpenAI-compatible server. They did not use credentials, contact a real model, or modify the active Pi 0.84.1 installation.
