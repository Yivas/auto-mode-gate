...
Version 0.4.0 adds global controls for the Pi permission judge. These controls require Pi 0.84.2.
They select the secondary model used for eligible permission decisions and never change Pi's primary
