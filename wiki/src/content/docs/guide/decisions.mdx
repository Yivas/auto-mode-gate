...
Auto Mode Gate applies deterministic rules before the permission judge. Version 0.4.0 restores the selected Pi judge model and thinking from global preferences; version 0.1.0 does not invoke a judge.
