...
Auto Mode Gate applies deterministic rules before the permission judge. Version 0.4.1 retains the global restoration of the selected Pi judge model and thinking introduced in 0.4.0; version 0.1.0 does not invoke a judge.
