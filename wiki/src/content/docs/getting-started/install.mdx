...
Merge that entry into an existing `plugin` array without removing other plugins or configuration. OpenCode resolves npm plugins declared in the file when it starts.
